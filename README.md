...
current version: [v0.9.0](https://github.com/timfayz/pretty/tags) (in progress: [v1.0.0](https://github.com/timfayz/pretty/commits/v1/))
...
$ zig fetch --save https://github.com/timfayz/pretty/archive/v0.9.0.tar.gz
$ cat build.zig.zon
..
  .pretty = .{
      .url = "https://github.com/timfayz/pretty/archive/v0.9.0.tar.gz",
      .hash = "..long_hash..",
  },
..
```
