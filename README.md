...
current version: [v0.10.0](https://github.com/timfayz/pretty/tags) (tested on `0.12.0`)
...
$ zig fetch --save https://github.com/timfayz/pretty/archive/v0.10.0.tar.gz
$ cat build.zig.zon
..
  .pretty = .{
      .url = "https://github.com/timfayz/pretty/archive/v0.10.0.tar.gz",
      .hash = "..long_hash..",
  },
..
```
