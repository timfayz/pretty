...
current version: [v0.10.4](https://github.com/timfayz/pretty/tags) (tested on `0.14.0`)
...
$ zig fetch --save https://github.com/timfayz/pretty/archive/v0.10.4.tar.gz
$ cat build.zig.zon
..
  .pretty = .{
      .url = "https://github.com/timfayz/pretty/archive/v0.10.4.tar.gz",
      .hash = "..long_hash..",
  },
..
```
