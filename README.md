...
current version: [v0.8.3](https://github.com/timfayz/pretty/tags)
...
$ zig fetch --save https://github.com/timfayz/pretty/archive/v0.8.3.tar.gz
$ cat build.zig.zon
..
  .pretty = .{
      .url = "https://github.com/timfayz/pretty/archive/v0.8.3.tar.gz",
      .hash = "..long_hash..",
  },
..
```
